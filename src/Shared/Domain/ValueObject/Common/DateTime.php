...
use Eurega\Shared\Domain\Exception\ValueObject\DateTimeIsNotValid;
...
final class DateTime
{
    ...
    public const FORMAT_DATE_EUROPE = 'd/m/Y';
     ...
     * @throws DateTimeIsNotValid
     */
    public static function createFromFormat(string $dateTime, string $format): self
    {
        try {
            return self::createFromDateTime(
    ...
    {
        return self::createFromDateTime(
            (new DateTimeImmutable('tomorrow', new DateTimeZone(Date::TIMEZONE)))
        );
    }
